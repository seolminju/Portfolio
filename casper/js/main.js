...
// 메인 팝업 체크 이벤트 발생시 로컬스토리지에 true/false 전달 기능
    ...
    $(".visual .downArrow").on("click", function () {
        if ($winWidth > 490) {
    ...
    const eventImg = $("#eventSlider .slick-slide");

    function mobileEventBanner() {
        if ($winWidth <= 490) {

            $secEvent.find(".item1 img").attr("src", "images/event_banner_mobile1.png");
            $secEvent.find(".item2 img").attr("src", "images/event_banner_mobile2.jpg");
            $secEvent.find(".item3 img").attr("src", "images/event_banner_mobile3.jpg");
            $secEvent.find(".item4 img").attr("src", "images/event_banner_mobile4.jpg");
            $secEvent.find(".item5 img").attr("src", "images/event_banner_mobile5.jpg");


            // for (let i = 1; i <= 5; i++) {
            //     let imgSrc;
            //     if (i === 2) {
            //         imgSrc = `images/event_banner_mobile${i}.jpg`;
            //     } else {
            //         imgSrc = `images/event_banner_mobile${i}.png`;
            //     }
            //     $secEvent.find(`.item${i} img`).attr("src", imgSrc);
            // }
            //
        } else {


            $secEvent.find(".item1 img").attr("src", "images/event_banner1.png");
            $secEvent.find(".item2 img").attr("src", "images/event_banner2.jpg");
            $secEvent.find(".item3 img").attr("src", "images/event_banner3.jpg");
            $secEvent.find(".item4 img").attr("src", "images/event_banner4.jpg");
            $secEvent.find(".item5 img").attr("src", "images/event_banner5.jpg");
        }
    }
